var num0 = document
  .querySelector("#num0")
  .addEventListener("click", num0Clicked);
var num1 = document
  .querySelector("#num1")
  .addEventListener("click", num1Clicked);
var num2 = document
  .querySelector("#num2")
  .addEventListener("click", num2Clicked);
var num3 = document
  .querySelector("#num3")
  .addEventListener("click", num3Clicked);
var num4 = document
  .querySelector("#num4")
  .addEventListener("click", num4Clicked);
var num5 = document
  .querySelector("#num5")
  .addEventListener("click", num5Clicked);
var num6 = document
  .querySelector("#num6")
  .addEventListener("click", num6Clicked);
var num7 = document
  .querySelector("#num7")
  .addEventListener("click", num7Clicked);
var num8 = document
  .querySelector("#num8")
  .addEventListener("click", num8Clicked);
var num9 = document
  .querySelector("#num9")
  .addEventListener("click", num9Clicked);
var input = document.querySelector("#input");
var num00 = document
  .querySelector("#num00")
  .addEventListener("click", num00Clicked);
var numDot = document
  .querySelector("#numDot")
  .addEventListener("click", numDotClicked);
var numclear = document
  .querySelector("#numClear")
  .addEventListener("click", clearAll);
var numEqual = document
  .querySelector("#numEqual")
